                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                              //  Get.to(OrderReceiptPage(transaction: {},));
                              },
                              child: Container(
                                height: 34,
                                width: 120,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(
                            () => Column(
                          children: [
                            ...controller.transactions.take(5).map((transactionObj) {
                              final transaction = transactionObj as Map<String, dynamic>;
                              ...
                              String outerCategory = possibleCategories[
                              controller.transactions.indexOf(transaction) %
                              ...
                              controller.transactions.indexOf(transaction) % statuses.length];
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...details.map((itemObj) {
                                            ...
                                            String itemPrice = item["price"] as String? ?? "";
                                            return Padding(
                            ...
                            /// 🔽 Yaha aur widgets add kar sakte ho
