...
// //                                                   cartController.updateItemQty(item, qty - 1);
// //
// //                                                   // ✅ Determine GlobalCart index using controller.catId
// //                                                   int cartIndex;
// //                                                   switch (cartController.catId) {
// //                                                     case "1": // Food
// //                                                       cartIndex = 0;
// //                                                       break;
// //                                                     case "2": // Liquor
...
// //                                                         GlobalCart.cartData[cartIndex]["order"][index]["qty"]);
// //                                                     currentQty -= 1;
// //
// //                                                     if (currentQty <= 0) {
// //                                                       GlobalCart.cartData[cartIndex]["order"].removeAt(index);
// //                                                     } else {
// //                                                       GlobalCart.cartData[cartIndex]["order"][index]["qty"] =
// //                                                       "$currentQty";
// //                                                     }
...
// //                                                 if (index != -1) {
// //                                                   int currentQty =
// //                                                   int.parse(GlobalCart.cartData[cartIndex]["order"][index]["qty"]);
// //                                                   GlobalCart.cartData[cartIndex]["order"][index]["qty"] =
// //                                                   "${currentQty + 1}";
// //                                                 } else {
...
//   final RxString searchQuery = "".obs;
//
//   MenuItemsPage({Key? key, required this.catId}) : super(key: key) {
//     // Create controller with unique tag based on catId
