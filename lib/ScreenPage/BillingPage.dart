          ...
          child: Column(
            ...
            children: [
              ...
              Icon(Icons.check_circle_outline,
                  size: 120,
                  color: orderSuccess ? Colors.green : AppColors.primary),
...
class BillingPage extends StatelessWidget {
  ...
  BillingPage({Key? key, required this.userName, required this.cartItems})
      : super(key: key);

  /// Generate text-based bill with single line per item
  String generateBill() {
    final buffer = StringBuffer();
    buffer.writeln("\n\n");
    buffer.writeln("====================================");
    buffer.writeln("          DSOI JABALPUR BILL        ");
    buffer.writeln("====================================");
    ...
    for (var item in cartItems) {
      String name = (item['name'] ?? '').padRight(20).substring(0, 20); // truncate if too long
      ...
      // ek hi line me name, qty, price
      buffer.writeln(
          "${name.padRight(20)} ${qty.toString().padLeft(3)}  ₹${itemTotal.toStringAsFixed(0).padLeft(5)}/-");
    }
